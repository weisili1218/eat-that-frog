...
class AppStrings {
  ...
  static const Map<String, String> _zh = {
    ...
    'newTaskBtn': '新增任務', 'plannerBtn': '自動安排今日行程',
    'plannerTitle': '安排今日行程', 'plannerHoursLabel': '今天有多少時間', 'hoursSuffix': '小時',
    'plannerEnergyLabel': '現在狀態', 'plannerGenerateBtn': '產生行程',
    'plannerResultHint': '依截止日與狀態排出的建議，可自行勾選後儲存',
    'plannerBackBtn': '重新設定', 'plannerEmpty': '收集匣沒有可安排的任務',
    'energyLv1': '很累', 'energyLv2': '偏累', 'energyLv3': '普通', 'energyLv4': '不錯', 'energyLv5': '很好',
    ...
    'dueLabel': '截止', 'reminderLabel': '提醒', 'durationLabel': '時長', 'overdueTag': '已逾期', 'dueSoonTag': '即將到期',
    ...
    'simulateMissedDayBtn': '模擬連勝中斷（測保護券）',
    'streakUnit': 'DAY',
    ...
    'signOutBody': '登出後會清除這台裝置上的本機資料（已同步的資料仍在雲端，下次登入會取回）。',
  ...
  static const Map<String, String> _en = {
    ...
    'newTaskBtn': 'New Task', 'plannerBtn': 'Auto-Plan Today',
    'plannerTitle': 'Plan Today', 'plannerHoursLabel': 'Hours available today', 'hoursSuffix': 'hrs',
    'plannerEnergyLabel': 'Current energy', 'plannerGenerateBtn': 'Generate Plan',
    'plannerResultHint': 'Suggested by deadline & energy — tick and save',
    'plannerBackBtn': 'Adjust', 'plannerEmpty': 'No tasks in Inbox to schedule',
    'energyLv1': 'Low', 'energyLv2': 'Meh', 'energyLv3': 'Okay', 'energyLv4': 'Good', 'energyLv5': 'Great',
    ...
    'dueLabel': 'Due', 'reminderLabel': 'Remind', 'durationLabel': 'Duration', 'overdueTag': 'Overdue', 'dueSoonTag': 'Due soon',
    ...
    'simulateMissedDayBtn': 'Simulate missed day (test freeze)',
    'streakUnit': 'DAY',
    ...
    'signOutBody': 'Signing out clears local data on this device. Anything synced stays in the cloud and returns on your next sign-in.',
